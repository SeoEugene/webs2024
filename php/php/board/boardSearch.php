<?php
    ...
    switch($searchOption){
        ...
        case "name":
            $sql .= "WHEREm.youName LIKE '%{$searchKeyword}%' ORDER BY boardID DESC";
            break;
    }
...
<?php
     ...
     if($page != $boardTotalCount){
         ...
         echo "<li class='last'><a href='boardSearch.php?page={$boardTotalCount}page={$nextPage}&searchKeyword={$searchKeyword}&searchOption={$searchOption}'>마지막으로</a></li>";
     }
?>
                </ul>
            </div>
