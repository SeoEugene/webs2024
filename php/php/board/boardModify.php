...
<?php
    ...
    if($result){
        ...
        echo "<div class='mt50'><label for='boardPass'>비밀번호</label><input type='password' id='boardPass' name='boardPass' class='input__style mb0' autocomplete='off' placeholder='비밀번호를 입력해주세요.'></div>";
    }
        ?>
